...
export interface CampaignLevel {
    ...
    isCompleted: boolean;
    stars: number;
    isHardMode?: boolean; // For UI rendering
    biome?: string; // Biome theme identifier
    unlocksItem?: string; // ID of item unlocked upon completion
}
