...
import { 
    CloseIcon, GridIcon, HistoryIcon, TrashIcon, 
        ...
        <>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        ...
                        <div className="space-y-8">
                            ...
                            <div>
                                ...
                                <div className="bg-red-50 dark:bg-red-500/5 border border-red-200 dark:border-red-500/20 rounded-3xl p-2 shadow-sm space-y-1">
                                    <SettingRow 
                                        label="Clear History" 
                                        description="Delete all replay data"
                                        icon={<HistoryIcon />} 
                                        ...
                                        action={<div />} 
                                    />
                                    <div className="h-px bg-red-200 dark:bg-red-500/10 mx-3" />
                                    <SettingRow 
            ...
            <AnimatePresence>
                {showHistoryConfirm && (
                    <ConfirmationModal 
                        title="Clear History"
                        description="This action cannot be undone. All your match replays will be gone forever."
                ...
                {showDeleteConfirm && (
                    <ConfirmationModal 
                        ...
                        description="This will permanently delete your profile, progress, and all data. This action is irreversible."
