...
import { CloseIcon, MessageIcon, UsersIcon, CheckIcon, SwordIcon, CoinIcon, SendIcon, CogIcon, GiftIcon, BellIcon, ReplyIcon } from './Icons';
...
const NotificationCenter: React.FC<NotificationCenterProps> = ({ onClose, onGoToSettings }) => {
    ...
    return (
        <motion.div 
            ...
            className="absolute top-16 right-0 w-[380px] max-h-[600px] flex flex-col bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border border-gray-200 dark:border-white/10 rounded-2xl shadow-2xl pointer-events-auto origin-top-right z-50 overflow-hidden"
        >
