...
export const DoubleIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        {/* Two distinct lightning bolts side-by-side */}
        <path d="M7 2L2 12h4l-2 10 8-10H8l3-10z" />
        <path d="M17 2l-5 10h4l-2 10 8-10h-4l3-10z" />
    </svg>
);

export const ConvertIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        {/* Magic Swap / Cycle with sparkle */}
        <path d="M21 10c0-4-3-7-8-7" />
        <path d="M21 3v7h-7" />
        <path d="M3 14c0 4 3 7 8 7" />
        <path d="M3 21v-7h7" />
        {/* Center Sparkle */}
        <path d="M12 8l1.5 3 3 1.5-3 1.5-1.5 3-1.5-3-3-1.5 3-1.5z" fill="currentColor" stroke="none" />
    </svg>
);
...
export const PotOfGoldIcon: React.FC<{className?: string}> = ({className}) => (
    <svg viewBox="0 0 100 100" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
            <linearGradient id="potBodyGrad" x1="50" y1="40" x2="50" y2="100" gradientUnits="userSpaceOnUse">
                <stop offset="0" stopColor="#f59e0b" />
                <stop offset="0.5" stopColor="#b45309" />
                <stop offset="1" stopColor="#78350f" />
            </linearGradient>
            <radialGradient id="goldShine" cx="0" cy="0" r="1" gradientUnits="userSpaceOnUse" gradientTransform="translate(35 60) rotate(90) scale(20)">
        ...
        {/* Back Coins */}
        <circle cx="35" cy="35" r="8" fill="url(#coinGradient)" stroke="#b45309" strokeWidth="1" />
        <circle cx="65" cy="35" r="8" fill="url(#coinGradient)" stroke="#b45309" strokeWidth="1" />
        <circle cx="50" cy="30" r="9" fill="url(#coinGradient)" stroke="#b45309" strokeWidth="1" />

        {/* Pot Body */}
        <path d="M15 45 Q15 90 50 90 Q85 90 85 45" fill="url(#potBodyGrad)" stroke="#78350f" strokeWidth="2" />
        <ellipse cx="50" cy="45" rx="35" ry="6" fill="#92400e" stroke="#78350f" strokeWidth="2" />
        
        {/* Highlight on Pot */}
        <ellipse cx="35" cy="60" rx="10" ry="15" fill="url(#goldShine)" transform="rotate(-15 35 60)" />

        {/* Front Coins */}
        <circle cx="42" cy="40" r="7" fill="url(#coinGradient)" stroke="#b45309" strokeWidth="1" />
        <circle cx="58" cy="40" r="7" fill="url(#coinGradient)" stroke="#b45309" strokeWidth="1" />
        <circle cx="50" cy="45" r="8" fill="url(#coinGradient)" stroke="#b45309" strokeWidth="1" />
        
        {/* Sparkles */}
        <path d="M85 25 L87 20 L89 25 L94 27 L89 29 L87 34 L85 29 L80 27 Z" fill="#fef08a" className="animate-pulse" />
        <path d="M15 30 L16 27 L17 30 L20 31 L17 32 L16 35 L15 32 L12 31 Z" fill="#fef08a" className="animate-pulse" style={{animationDelay: '0.5s'}} />
    </svg>
);

export const TowerIcon: React.FC<{className?: string}> = ({className}) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M4 21h16" />
