...
import { CoinIcon, CheckIcon, CopyIcon, LinkIcon } from './Icons';
            ...
            <div className="flex flex-col md:flex-row justify-between items-center gap-6 mt-8">
                ...
                <div id="wager-pot-display" className="flex flex-col items-center justify-center text-center shrink-0">
                    <motion.div 
                        ...
                        className="w-16 h-16 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center shadow-lg mb-2 border-2 border-yellow-300"
                    >
                        <CoinIcon className="w-8 h-8 text-yellow-900" />
                    </motion.div>
                    <motion.div 
                        key={`pot-${currentPot}`}
                    ...
                    <div className="text-xs font-bold text-yellow-400 uppercase">Total Pot</div>
                </div>
